...
void i2c_read_sanity_check() {
	...
	// Basic null check
	TEST_ASSERT_EQUAL_MESSAGE(-1, i2c_read(mock, MCP23008_FIRST_ADDR, NULL, NULL), strerror(errno));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));
	
	TEST_ASSERT_EQUAL_MESSAGE(-1, i2c_read(mock, MCP23008_FIRST_ADDR, NULL, &to_read11), strerror(errno));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL_MESSAGE(-1, i2c_read(mock, MCP23008_FIRST_ADDR, &read_order11, NULL), strerror(errno));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL_MESSAGE(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order11, &to_read11), strerror(errno));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));
	

	// Sanity checks
	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order00, &to_read00));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order00, &to_read01));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order00, &to_read10));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order00, &to_read11));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));
	...
	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order01, &to_read00));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order01, &to_read01));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order01, &to_read10));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order01, &to_read11));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));
	...
	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order10, &to_read00));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order10, &to_read01));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order10, &to_read10));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order10, &to_read11));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));
	...
	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order11, &to_read00));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order11, &to_read01));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order11, &to_read10));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, 0x8F, &read_order11, &to_read11));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));
	...
	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order00, &to_read00));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order00, &to_read01));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order00, &to_read10));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order00, &to_read11));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));
	...
	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order01, &to_read00));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order01, &to_read01));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order01, &to_read10));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order01, &to_read11));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));
	...
	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order10, &to_read00));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order10, &to_read01));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order10, &to_read10));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order10, &to_read11));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));
	...
	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order11, &to_read00));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order11, &to_read01));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order11, &to_read10));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));

	TEST_ASSERT_EQUAL(-1, i2c_read(NULL, MCP23008_FIRST_ADDR, &read_order11, &to_read11));
	TEST_ASSERT_EQUAL_MESSAGE(EFAULT, errno, strerror(errno));
...
void i2c_read_test() {
	i2c_interface_t* i2c = i2c_init(1);
        ...
        // First MCP23008 test
        TEST_ASSERT_EQUAL_MESSAGE(0, i2c_write(i2c, MCP23008_FIRST_ADDR, &set_output), strerror(errno));
        TEST_ASSERT_EQUAL_MESSAGE(0, i2c_read(i2c, MCP23008_FIRST_ADDR, &read_order_iodir, &to_read), strerror(errno));
        ...
        TEST_ASSERT_EQUAL_MESSAGE(0, i2c_read(i2c, MCP23008_FIRST_ADDR, &read_order_olat, &to_read), strerror(errno));
        ...
        // Second MCP23008 test
        TEST_ASSERT_EQUAL_MESSAGE(0, i2c_write(i2c, MCP23008_SECOND_ADDR, &set_output), strerror(errno));
        TEST_ASSERT_EQUAL_MESSAGE(0, i2c_read(i2c, MCP23008_SECOND_ADDR, &read_order_iodir, &to_read), strerror(errno));
        TEST_ASSERT_EQUAL_MEMORY_MESSAGE(&set_output.buff[1], to_read.buff, 1, strerror(errno));

        TEST_ASSERT_EQUAL_MESSAGE(0, i2c_write(i2c, MCP23008_SECOND_ADDR, &pull_some_high), strerror(errno));
        TEST_ASSERT_EQUAL_MESSAGE(0, i2c_read(i2c, MCP23008_SECOND_ADDR, &read_order_olat, &to_read), strerror(errno));
        TEST_ASSERT_EQUAL_MEMORY_MESSAGE(&pull_some_high.buff[1], to_read.buff, 1, strerror(errno));
        ...
        TEST_ASSERT_EQUAL_MESSAGE(-1, i2c_write(i2c, MCP23008_NONEXIST_ADDR, &set_output), strerror(errno));
        TEST_ASSERT_EQUAL_MESSAGE(-1, i2c_read(i2c, MCP23008_NONEXIST_ADDR, &read_order_iodir, &to_read), strerror(errno));

        TEST_ASSERT_EQUAL_MESSAGE(-1, i2c_write(i2c, MCP23008_NONEXIST_ADDR, &pull_some_high), strerror(errno));
        TEST_ASSERT_EQUAL_MESSAGE(-1, i2c_read(i2c, MCP23008_NONEXIST_ADDR, &read_order_olat, &to_read), strerror(errno));
