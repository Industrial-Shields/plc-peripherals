...
#ifndef __PERIPHERAL_PCA9534D_H__
#define __PERIPHERAL_PCA9534D_H__

#include <stdint.h>
#include <i2c-interface.h>

#define PCA9534D_NUM_IO 8

#define PCA9534D_OUTPUT 0
#define PCA9534D_INPUT 1
...
extern "C" {
	...
	/**
	 * @brief Initializes the PCA9534D GPIO expander.
	 *
	 * This function initializes the PCA9534D GPIO expander at the specified address.
	 *
	...
	/**
	 * @brief De-initializes the PCA9534D.
	 *
	 * This function de-initializes the PCA9534D.
	 *
	 * @param i2c Pointer to the I2C interface structure.
	 * @param addr The I2C address of the PCA9534D.
	...
	/**
	 * @brief Sets the pin mode for a specific pin on the PCA9534D GPIO expander.
	 *
	 * This function sets the mode for a specific pin on the PCA9534D GPIO expander.
	 *
	 * @param i2c Pointer to the I2C interface structure.
	 * @param addr The I2C address of the PCA9534D.
	...
	/**
	 * @brief Sets the pin mode for all pins on the PCA9534D GPIO expander.
	 *
	 * This function sets the mode for all pins on the PCA9534D GPIO expander at the same time
	 * with a mask, each bit representing it's index (bit 7 == P7).
	 *
	 * @param i2c Pointer to the I2C interface structure.
	 * @param addr The I2C address of the PCA9534D.
	...
	/**
	 * @brief Reads the value of a specific input pin on the PCA9534D GPIO expander.
	 *
	 * This function reads the value of a specific input pin on the PCA9534D GPIO expander.
	 *
	 * @param i2c Pointer to the I2C interface structure.
	 * @param addr The I2C address of the PCA9534D.
	...
	/**
	 * @brief Writes the value of a specific output pin on the PCA9534D GPIO expander.
	 *
	 * This function writes the value of a specific output pin on the PCA9534D GPIO expander.
	 *
	 * @param i2c Pointer to the I2C interface structure.
	 * @param addr The I2C address of the PCA9534D.
	 * @param index The pin index (0-7) to write the value to.
	...
	/**
	 * @brief Reads the values of all pins on the PCA9534D GPIO expander.
	 *
	 * This function reads the values of all pins on the PCA9534D GPIO expander, and returns
	 * it as a 8 bit integer, each bit representing it's index (bit 7 == P7).
	 *
	 * @param i2c Pointer to the I2C interface structure.
	 * @param addr The I2C address of the PCA9534D.
	...
	/**
	 * @brief Writes a value to all pins on the PCA9534D GPIO expander.
	 *
	 * This function writes a value to all pins on the PCA9534D GPIO expander
	 * directly, each bit representing it's index (bit 7 == P7).
	 *
	 * @param i2c Pointer to the I2C interface structure.
	 * @param addr The I2C address of the PCA9534D.
